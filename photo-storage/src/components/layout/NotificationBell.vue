...
<template>
  <div class="relative">
    <button class="relative p-2 text-gray-500 hover:text-gray-700" @click="open = !open">
    ...
    >
      ...
      >
        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          <h4 class="text-sm font-semibold text-gray-900">Thông báo</h4>
          <button
            v-if="store.unreadCount > 0"
        ...
        <div class="max-h-80 overflow-y-auto">
          <div
            ...
            :key="n.id"
            :class="['px-4 py-3 border-b border-gray-50 last:border-0 cursor-pointer hover:bg-gray-50', !n.read ? 'bg-orange-50/50' : '']"
