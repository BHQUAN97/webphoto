...
<template>
  ...
  <div class="max-w-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <h2 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('settings.changePassword') }}</h2>
      ...
      <form @submit.prevent="changePassword" class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">{{ $t('settings.newPassword') }}</label>
          <input
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">{{ $t('settings.confirmNewPassword') }}</label>
          <input
